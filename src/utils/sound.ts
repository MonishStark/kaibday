...
export class SoundManager {
  ...
  constructor() {
    if (typeof window !== 'undefined') {
      // Defer DOM element binding to initial tick
      setTimeout(() => {
  ...
  // Restart Birthday Song explicitly from 0.0s
  public restartBirthdaySong = () => {
    ...
    if (playPromise !== undefined) {
      playPromise.then(() => {
        ...
        console.warn('Restart notice:', err);
      });
    }
  };
  ...
  public playSteam = () => {
    ...
    try {
      ...
      console.warn('Steam sound error:', e);
    }
  };
  ...
  public playBlowCandles = () => {
    ...
    try {
      ...
      console.warn('Blow candles error:', e);
    }
  };
